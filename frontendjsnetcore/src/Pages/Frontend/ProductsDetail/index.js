      ...
      <div className="row">
        <div className="col-md-8">
          ...
          <p>
            ...
            thermocouple. Thermostatic adjustable per zone. Comes complete with
            lava rocks. Adjustable legs. Lorem ipsum dolor sit amet, consectetur
        ...
        <aside className="col-md-4">
          <div className="box">
            ...
            <article className="media mb-3">
              <a href="#">
                <img className="img-sm mr-3" src="../../../../public/imagesposts/3.jpg" />
              </a>
            ...
            <article className="media mb-3">
              <a href="#">
                <img className="img-sm mr-3" src="../../../../public/imagesposts/2.jpg" />
              </a>
              <div className="media-body">
                <h6 className="mt-0">
            ...
            <article className="media mb-3">
              <a href="#">
                <img className="img-sm mr-3" src="../../../../public/imagesposts/1.jpg" />
              </a>
              <div className="media-body">
                <h6 className="mt-0">
                  <a href="#">New tips and tricks</a>
